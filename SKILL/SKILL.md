...
## 基础仓库 URL
https://Timtr1x.github.io/daily-arXiv-ai-enhanced/
...
## 样例
```
bash scripts/fetch.sh "https://Timtr1x.github.io/daily-arXiv-ai-enhanced/?category=cs.CV&author=Smith&keywords=deep"
```
